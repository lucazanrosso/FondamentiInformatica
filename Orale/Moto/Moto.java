...
public class Moto {
	...
	*/
	...
	/*
	Questo metodo e il metodo randomInt servono per generare il codice di immatricolazione. 
	I primi due caratteri sono due lettere dell'alfabeto maiuscole prese a random dalla variabile 
	di istanza alfabeto. Gli ultimi tre caratteri sono tre cifre progressive formattate con il 
	metodo statico format della classe String che, in questo caso, permette di stampare sempre 
	tre cifre, anche se contaMoto è uguale a 1 (verrà stampato 001).
	*/
	...
	*/
	...
	La variabile che rende univoco ogni oggetto Moto è la targa, quindi utilizzo la targa
