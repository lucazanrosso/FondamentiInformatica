...
0, 1, 2, 4, 7 e 8. In questa classe non ho mai usato i simboli +, -, *, /, %, ecc. Per fare le operazioni
ho usato sempre i metodi creati, quindi somma, differenzaRelatica, prodotto, ecc. Ho fatto questo
...
public class Aritmetica {
	...
	*/
	...
	2.1
	MCD
	L'unica cosa diversa rispetto al while program proposto e è che ho usato
	3 cicli while al posto di 1 ciclo do-while e 2 cicli while.
	*/
	...
	*/
	...
	di Kleene, ora bisogna usare il formalismo di McCarthy.
