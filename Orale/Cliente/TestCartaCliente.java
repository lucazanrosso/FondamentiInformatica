public class TestCartaCliente {
	...
	public static void main(String[] args) {
		...
		*/
		System.out.println();
		if (cartaFedelta1.getCliente().getCategoria().equals(cartaFedelta2.getCliente().getCategoria()))
...
Bene, i due clienti sono persone diverse

Nome Cliente: Zanrosso Luca
Identificatore: 000001SIG
Anno rilascio tesserino: 2015
Anni validità carta fedeltà: 3
Punti carta fedeltà: 1000

Nome Cliente: Zanrosso Andrea
Identificatore: 000002SIG
Anno rilascio tesserino: 2015
Anni validità carta fedeltà: 5
Punti carta fedeltà: 1000

I due clienti hanno la stessa categoria
*/