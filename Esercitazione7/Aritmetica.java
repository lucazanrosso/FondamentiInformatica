...
public class Aritmetica {
	...
	public static void main (String[] args) {
		...
		if (! (operatore.equals("q") ||
				operatore.equals("sg") ||
				operatore.equals("sg*") ||
				operatore.equals("fat") ||
				operatore.equals("fatric") ||
				operatore.equals("rad") ||
				operatore.equals("intrad") ||
				operatore.equals(""))) {
		...
		switch(operatore) {
			...
			case "min":
				...
				break;
			case "fat":
				System.out.println(fattoriale(operando1));
				break;
			case "fatric":
				System.out.println(fattorialeRicorsivo(operando1));
				break;
			case "rad":
				if (controllaQuadratoPerfetto(operando1))
					System.out.println(radiceQuadrataPerfetta(operando1));
				else
					System.out.println(operando1 + " non \u00E8 un quadrato perfetto");
				break;
			case "intrad":
				System.out.println(parteInteraRadiceQuadrata(operando1));
				break;
			case "+r":
				System.out.println(sommaRicorsiva(operando1, operando2));
				break;
			case "*r":
				System.out.println(prodottoRicorsivo(operando1, operando2));
				break;
			case "^r":
				System.out.println(esponenzialeRicorsivo(operando1, operando2));
				break;
		}
	...
	*/
	...
	public static int prodottoRicorsivo(int x, int y) {
		if (x == 0 || y == 0)
			...
			return sommaRicorsiva(x, prodottoRicorsivo(x, y - 1));
	}
	...
	public static int esponenzialeRicorsivo(int x, int y) {
		if (y == 0)
			...
			return prodottoRicorsivo(x, esponenzialeRicorsivo(x, y - 1));
	}
	...
	*/
	public static boolean controllaQuadratoPerfetto(int x) {
		int y = 0;
		while (differenza(x, quadrato(y)) != 0)
			y = successore(y);
		if (x == quadrato(y))
			return true;
		return false;
	...
	*/
	public static int parteInteraRadiceQuadrata(int x) {
			int y = 0;
			while (differenza(x, predecessore(quadrato(successore(y)))) != 0)
				y = successore(y);
			return y;
	}
}